                        ...
                        <div class="card-body row">
                            <div class="col-md-8">
                                <div class="row" style="margin-top: 7%">
                                    <p class="card-title" style="font-family: Roboto; font-size:20px; font-weight: bold; color:#333333; margin: auto; width: 50%; text-align:center">
                                        {{$item['tipe_armada']['tipe']}}
                                    </p>
                                </div>
                                <div class="row" style="margin-top: 7%">
                                    <div style="margin: auto; width:80%; height:100px">
                                        <img src="{{asset($item['photo'])}}" alt="{{$item['tipe_armada']}}" >
                                    </div>
                                </div>
                                <div class="row" style="margin-top: 7%">
                                    <p class="card-text col-md-12" style="margin-bottom: 0; padding-left:15%">Start From</p>
                                    <p class="card-text col-md-12" style="font-family: Roboto; font-size:20px; font-weight: bold; color:#000; padding-left:15%">{{ 'Rp.'.number_format($item['price'],0,',','.') }}</p>
                                </div>
                            </div>
                            <div class="col-md-4" style="position: relative">
                                <div class="row" style="position: absolute; bottom:0;">
                                    ...
                                    <div class="col-md-12">
                                        <a class="btn-booking" href="#" role="button" style="width: 85%">BOOK</a>
                                    </div>
                                </div>
                            </div>
                        </div>
