...
@section('content')
        ...
        <div class="col">
            <div class="alert alert-light alert-elevate fade show" role="alert">
                ...
                <div class="alert-text">
                    Pada page ini anda dapat menambahkan data tipe armada
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="kt-portlet">
        <div class="kt-portlet__body">
            ...
            <form action="{{route('tipe_armada.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
                <div class="row">
                    {{-- Input field --}}
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="number" class="form-control" name="kapasitas_penumpang" value="{{old('kapasitas_penumpang')}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-4 col-form-label">
                            ...
                            <div class="col-8">
                                <select class="form-control" name="tipe_kemudi" required>
                                    ...
                                    @foreach ($tipe_kemudi as $item)
                                        <option value="{{ $item }}" @if(old('tipe_kemudi') !== null && old('tipe_kemudi') == $item) selected @endif>{{ ucfirst($item) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                                    <label>
                                        <input type="checkbox" name="is_driver_allowed" id="is_driver_allowed" @if(old('is_driver_allowed') !== null && old('is_driver_allowed') == 'on') checked="checked" @endif>
                                        <span></span>
                                    </label>
                                </span>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 mt-2">
                                <input type="checkbox" name="price-check" id="price-check" @if(old('price-check') !== null && old('price-check') == 'on') checked="checked" @endif> Gunakan Tarif 24 Jam
                            </div>
                            <div class="col-md-4"></div>
                            <div class="col-md-8 mt-2">
