                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input class="form-control" type="text" name="price12" id="price12" placeholder="Tarif 12 Jam" autocomplete="off" min="0" value="Rp {{ number_format($tipe_armada['price12'],0,'.',',') }}" required>
                            </div>
